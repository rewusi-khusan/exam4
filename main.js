...
alert("MARS IT SCHOOL so'zi " + count + " harfdan iborat");
...
console.log(harflar[21] + harflar[19] + harflar[17] + harflar[0] + harflar[12]);
...
if (age < 18) {
    console.log("Siz balog'at yoshiga yetmadingiz");
} else if (age >= 18) {
    console.log("Siz balog'at yoshiga yetdingiz");
}
...
let week = +prompt("1 dan 7 gacha raqam kiriting")
...
switch (week) {
    ...
    default: week > 7
        console.log("Nomalum son kiritdingiz");
        break;
}
